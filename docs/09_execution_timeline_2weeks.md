...
### Day 4
- Define history-match ML architecture/loss/dataset strategy.
- Output: `06` locked.
...
### Day 10
- Start dataset generation and history-match ML training baseline.
...
2. Numerics lock (`03`) -> CPU validation (`07`) -> history-match ML evidence (`06`,`07`) -> GPU parity and optimization evidence (`05`,`07`).
...
- During implementation, history-match ML training/evaluation can proceed before final GPU optimization as long as output schemas remain frozen.
